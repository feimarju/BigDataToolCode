function kv_result=bowThrBoots_MR(ds,textVar,thresholdVar,threshold,filteringVar,valueFilter)
...
% Mapreduce
outds = mapreduce(ds,@(data,info,kvs)BoWThrBootsMapFun(data,info,kvs,...
