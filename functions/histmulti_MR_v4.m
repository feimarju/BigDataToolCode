function [countings_G1,countings_G2,countings_G3,groupNames]=...
    histmulti_MR_v4(ds,thresholdVar,threshold,grouperVar,filteringVar,valueFilter,nBins,thrFnc)
...
% Mapreduce
outds = mapreduce(ds,@(data,info,kvs)MultiCountMapFun_v4(data,info,kvs,...
