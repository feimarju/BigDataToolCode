...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [significativas,possorted]=showMmodeAndCounts(miHist,ejeHist,groupNames,grouperVar,valueFilter,countCats,CI)%,type)
...
input = uicontrol('Style','edit','String',sprintf('CI: %.1f%%',CI),'Units','normal','Position',[0.1125 0.8367 0.15 0.05],'Callback', @CIinput,'Visible','on');
ha=[]; showPlots(1);
