function [countings_G1,countings_G2,hists]=...
    histmulti_MR_v2(ds,thresholdVar,threshold,grouperVar,filteringVar,valueFilter,nBins,thrFnc)
...
% Mapreduce
outds = mapreduce(ds,@(data,info,kvs)MultiCountMapFun_v2(data,info,kvs,...
