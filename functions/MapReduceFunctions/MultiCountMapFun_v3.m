function MultiCountMapFun_v3(data,~,intermKVStore,vars,thr,subsetter,nBins,thrFnc)
...
for i=1:nTypes
    ...
    %miHist = myBootOdds(countings(i),sum(idxG1),countings(i+nTypes),sum(idxG2),ejeHist,nBins);
